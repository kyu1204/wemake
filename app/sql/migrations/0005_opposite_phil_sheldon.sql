...
--> statement-breakpoint
ALTER TABLE "gpt_idea_likes" ALTER COLUMN "gpt_idea_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "gpt_idea_likes" ALTER COLUMN "profile_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "product_upvotes" ALTER COLUMN "product_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "product_upvotes" ALTER COLUMN "profile_id" SET NOT NULL;--> statement-breakpoint
